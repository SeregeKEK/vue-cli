    ...
    <footer class="footer">
        ...
        <div class="footer__contact">
            ...
            <div class="footer__contact-text">
                <p class="footer__contact-address">55 East Birchwood Ave. Brooklyn, New York 11201</p>
                <a href="mailto:contact@interno.com" class="footer__contact-mail">contact@interno.com</a>
                <a href="tel:+71234567890" class="footer__contact-phone">(123) 456 - 7890</a>
            </div>
        </div>
    </footer>
</template>
